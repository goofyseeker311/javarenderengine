		...
		if ((vsurf!=null)&&(campos!=null)) {
			...
			for (int i=0;i<vsurf.length;i++) {
				if ((camfwdvsufrint[0][i]!=null)&&(ppint[0][i]!=null)&&(camfwdvsufrint[0][i].isFinite())&&(ppint[0][i].isFinite())) {
					...
					Position[] camfwdvsurfpos3 = translate(camfwdvsurfpos,horizlinedir[0],1.0f);
					Line[] centerheightline = {new Line(camfwdvsurfpos[0], camfwdvsurfpos2[0])};
					Line[] centerwidthline = {new Line(camfwdvsurfpos[0], camfwdvsurfpos3[0])};
					...
					double fwdoutvangle1 = asind((refraction1/refraction2)*sind(fwdvendangle1));
					double fwdoutvangle2 = asind((refraction1/refraction2)*sind(fwdvendangle2));
					double fwdouthangle1 = asind((refraction1/refraction2)*sind(fwdhendangle1));
					double fwdouthangle2 = asind((refraction1/refraction2)*sind(fwdhendangle2));
					...
					double refcamendhalfangle = 180.0f - reffwdvangle2 - refcamhalfvfov;
					double reffwdend2len = sind(reffwdvangle1)/sind(refcamvfov)*camfwdvenddir12len[0];
					double reffwd12halfanglelen = sind(refcamhalfvfov)/sind(refcamendhalfangle)*reffwdend2len;
					double refdir12len = reffwdend2len*cosd(reffwdvangle2);
					double refnormlen = reffwdend2len*sind(reffwdvangle2);
					Position[] camposrefraction = camfwdvsurfvendpos2;
					camposrefraction = translate(camposrefraction,camfwdvenddir12invn[0],refdir12len);
					camposrefraction = translate(camposrefraction,vsurfnormal[0],refnormlen);
					Position[] refcamfwdhalfendpos = translate(camfwdvsurfvendpos2,camfwdvenddir12invn[0],reffwd12halfanglelen);
